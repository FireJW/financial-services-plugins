#!/usr/bin/env python3
"""
Run a one-shot X post indexing request and bridge it into news-index.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input", help="Path to an x-index request JSON file")
