...
def build_feedback_markdown(
    ...
    *,
    ...
    lines = [
        ...
        f"- Human signal ratio: {int(request.get('human_signal_ratio', 0) or 0)}",
        f"- Personal phrase bank: {', '.join(clean_string_list(request.get('personal_phrase_bank'))) or 'none'}",
        ...
        ">   Why: ...",
        ">   Scope: topic",
        "> - Key: personal_phrase_bank",
        ">   Value: 先说结论",
        ">   Why: This sounds more like my own writing rhythm.",
        ">   Scope: global",
        "",
        "## One-Off Fact Fixes",
        "",
