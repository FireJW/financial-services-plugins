...
from article_batch_workflow_runtime import load_json, run_article_batch_workflow, write_json
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input", help="Path to a batch request JSON file")
    parser.add_argument("--output", help="Optional path to save the batch workflow result JSON")
    parser.add_argument("--markdown-output", help="Optional path to save the batch workflow markdown report")
...
def main() -> None:
    ...
    try:
        ...
        result = run_article_batch_workflow(payload)
        if not args.quiet:
