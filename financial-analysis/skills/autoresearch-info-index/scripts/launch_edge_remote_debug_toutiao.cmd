...
if not errorlevel 1 (
  ...
  echo Keep the current signed-in profile if it already has the Toutiao session.
...
start "" "%EDGE_EXE%" --remote-debugging-port=9222 --profile-directory=Default --new-window https://mp.toutiao.com/
exit /b 0
