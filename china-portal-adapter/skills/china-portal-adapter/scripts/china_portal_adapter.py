...
from china_portal_adapter_runtime import run_china_portal_adapter, write_json, write_text


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the fixture-first China portal adapter.")
    ...
    result = run_china_portal_adapter(request)
    if args.output:
